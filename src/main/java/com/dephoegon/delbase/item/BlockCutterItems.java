...
public class BlockCutterItems extends BaseItems {
    ...
    */
    private static Item blockCutterItemHelper(String name, int maxCount) { return registerItem(name, new Item(new Item.Settings().maxCount(maxCount))); }
    public static void registerItems() { Delbase.LOGGER.info("Registering "+Delbase.Delbase_ID+" BlockCutter Items"); }
}
