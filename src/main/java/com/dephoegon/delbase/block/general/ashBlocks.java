...
public class ashBlocks extends baseModBlocks {
    private static final AbstractBlock.Settings ashBlock = FabricBlockSettings.copyOf(OAK_WOOD).sounds(BlockSoundGroup.WOOD);
    public static final SlabBlock ASH_SLAB = (SlabBlock) registerBlock("ash_slab", new slabBlock(ashBlock, "", "", "", null), 8000);
