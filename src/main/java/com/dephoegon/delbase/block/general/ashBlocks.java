...
public class ashBlocks extends baseModBlocks {
    ...
    public static final PillarBlock ASH_LOG = (PillarBlock) registerBlock("ash_log", new modPillarBlock(ashBlock, "","","", null), 16000);
    public static final WallBlock ASH_WALL = (WallBlock) registerBlock("ash_wall", new wallBlock(ashBlock, "","","", null), 10000);
    public static final Block ASH_BLOCK = registerBlock("ash_block", new modGenBlock(ashBlock,"", "", "", null), 16000);
