...
public class leafFences extends baseModBlocks {
    ...
    public static final FenceBlock MANGROVE_LEAF_FENCE = noToolTipFAid("mangrove_leaf_fence", MANGROVE_LEAVES);
    public static final FenceGateBlock MANGROVE_LEAF_FENCE_GATE = noToolTipFgAid("mangrove_leaf_fence_gate", MANGROVE_LEAVES);
