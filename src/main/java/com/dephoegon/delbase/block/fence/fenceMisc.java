...
public class fenceMisc extends baseModBlocks {
    ...
    public static final FenceGateBlock SCULK_FENCE_GATE = noToolTipFgAid("sculk_fence_gate", SCULK, BlockSoundGroup.SCULK);
    ...
    public static final FenceGateBlock PACKED_MUD_FENCE_GATE = noToolTipFgAid("packed_mud_fence_gate", PACKED_MUD, BlockSoundGroup.PACKED_MUD);
    public static final FenceBlock MUDDY_MANGROVE_ROOT_FENCE = noToolTipFAid("muddy_mangrove_root_fence", MUDDY_MANGROVE_ROOTS);
