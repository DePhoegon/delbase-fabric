...
public class strippedWoodenFences extends baseModBlocks {
    ...
    public static final FenceGateBlock STRIPPED_ACACIA_WOOD_FENCE_GATE = noToolTipFgAid("stripped_acacia_wood_fence_gate", ACACIA_WOOD, true);
    public static final FenceBlock STRIPPED_ACACIA_LOG_FENCE = noToolTipFAid("stripped_acacia_log_fence", ACACIA_WOOD, true);
    public static final FenceGateBlock STRIPPED_ACACIA_LOG_FENCE_GATE = noToolTipFgAid("stripped_acacia_log_fence_gate", ACACIA_WOOD, true);
    public static final FenceBlock STRIPPED_BIRCH_WOOD_FENCE = noToolTipFAid("stripped_birch_wood_fence", BIRCH_WOOD, true);
    public static final FenceGateBlock STRIPPED_BIRCH_WOOD_FENCE_GATE = noToolTipFgAid("stripped_birch_wood_fence_gate", BIRCH_WOOD, true);
    public static final FenceBlock STRIPPED_BIRCH_LOG_FENCE = noToolTipFAid("stripped_birch_log_fence", BIRCH_WOOD, true);
    public static final FenceGateBlock STRIPPED_BIRCH_LOG_FENCE_GATE = noToolTipFgAid("stripped_birch_log_fence_gate", BIRCH_WOOD, true);
    ...
    public static final FenceGateBlock STRIPPED_CRIMSON_HYPHAE_FENCE_GATE = noToolTipFgAid("stripped_crimson_hyphae_fence_gate", CRIMSON_HYPHAE, false);
    ...
    public static final FenceGateBlock STRIPPED_CRIMSON_STEM_FENCE_GATE = noToolTipFgAid("stripped_crimson_stem_fence_gate", CRIMSON_HYPHAE, false);
    ...
    public static final FenceGateBlock STRIPPED_DARK_OAK_WOOD_FENCE_GATE = noToolTipFgAid("stripped_dark_oak_wood_fence_gate", DARK_OAK_WOOD, true);
    public static final FenceBlock STRIPPED_DARK_OAK_LOG_FENCE = noToolTipFAid("stripped_dark_oak_log_fence", DARK_OAK_WOOD, true);
    public static final FenceGateBlock STRIPPED_DARK_OAK_LOG_FENCE_GATE = noToolTipFgAid("stripped_dark_oak_log_fence_gate", DARK_OAK_WOOD, true);
    public static final FenceBlock STRIPPED_JUNGLE_WOOD_FENCE = noToolTipFAid("stripped_jungle_wood_fence", JUNGLE_WOOD, true);
    public static final FenceGateBlock STRIPPED_JUNGLE_WOOD_FENCE_GATE = noToolTipFgAid("stripped_jungle_wood_fence_gate", JUNGLE_WOOD, true);
    public static final FenceBlock STRIPPED_JUNGLE_LOG_FENCE = noToolTipFAid("stripped_jungle_log_fence", JUNGLE_WOOD, true);
    public static final FenceGateBlock STRIPPED_JUNGLE_LOG_FENCE_GATE = noToolTipFgAid("stripped_jungle_log_fence_gate", JUNGLE_WOOD, true);
    public static final FenceBlock STRIPPED_OAK_WOOD_FENCE = noToolTipFAid("stripped_oak_wood_fence", OAK_WOOD, true);
    public static final FenceGateBlock STRIPPED_OAK_WOOD_FENCE_GATE = noToolTipFgAid("stripped_oak_wood_fence_gate", OAK_WOOD, true);
    public static final FenceBlock STRIPPED_OAK_LOG_FENCE = noToolTipFAid("stripped_oak_log_fence", OAK_WOOD, true);
    public static final FenceGateBlock STRIPPED_OAK_LOG_FENCE_GATE = noToolTipFgAid("stripped_oak_log_fence_gate", OAK_WOOD, true);
    public static final FenceBlock STRIPPED_SPRUCE_WOOD_FENCE = noToolTipFAid("stripped_spruce_wood_fence", SPRUCE_WOOD, true);
    public static final FenceGateBlock STRIPPED_SPRUCE_WOOD_FENCE_GATE = noToolTipFgAid("stripped_spruce_wood_fence_gate", SPRUCE_WOOD, true);
    public static final FenceBlock STRIPPED_SPRUCE_LOG_FENCE = noToolTipFAid("stripped_spruce_log_fence", SPRUCE_WOOD, true);
    public static final FenceGateBlock STRIPPED_SPRUCE_LOG_FENCE_GATE = noToolTipFgAid("stripped_spruce_log_fence_gate", SPRUCE_WOOD, true);
    ...
    public static final FenceGateBlock STRIPPED_MANGROVE_WOOD_FENCE_GATE_BLOCK = noToolTipFgAid("stripped_mangrove_wood_fence_gate", STRIPPED_OAK_WOOD, true);
    ...
    public static final FenceGateBlock STRIPPED_MANGROVE_LOG_FENCE_GATE_BLOCK = noToolTipFgAid("stripped_mangrove_log_fence_gate", STRIPPED_OAK_WOOD, true);
    ...
    private static FenceGateBlock noToolTipFgAid(String name, Block block, boolean burnable) {
        if (burnable) { return burnFenceGateBlockAid(name, block, "", "", ""); }
        return fenceGateBlockAid(name, block, "","", ""); }
    ...
    private static FenceGateBlock fenceGateBlockAid(String name, Block block, String NormToolTip, String ShiftToolTip, String CtrlToolTip) {
        return  (FenceGateBlock) registerBlock(name, new strippedWoodFenceGate(FabricBlockSettings.copyOf(block).sounds(BlockSoundGroup.WOOD), NormToolTip, ShiftToolTip, CtrlToolTip));
    }
    @SuppressWarnings("SameParameterValue")
    ...
    @SuppressWarnings("SameParameterValue")
    private static FenceGateBlock burnFenceGateBlockAid(String name, Block block, String NormToolTip, String ShiftToolTip, String CtrlToolTip) {
        return  (FenceGateBlock) registerBlock(name, new strippedWoodFenceGate(FabricBlockSettings.copyOf(block).sounds(BlockSoundGroup.WOOD), NormToolTip, ShiftToolTip, CtrlToolTip),true, 1000, 5, 10);
    }
