...
public class woodenFences extends baseModBlocks {
    ...
    public static final FenceGateBlock MANGROVE_WOOD_FENCE_GATE_BLOCK = noToolTipFgAid("mangrove_wood_fence_gate", OAK_WOOD, STRIPPED_MANGROVE_WOOD_FENCE_GATE_BLOCK, true);
    ...
    public static final FenceGateBlock MANGROVE_LOG_FENCE_GATE_BLOCK = noToolTipFgAid("mangrove_log_fence_gate", OAK_WOOD, STRIPPED_MANGROVE_LOG_FENCE_GATE_BLOCK, true);
