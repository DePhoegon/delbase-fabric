...
public class slabSmoothSandStonesEnergy extends baseModBlocks {
    public static final SlabBlock SMOOTH_SAND_STONE_SLAB_ENERGY = noToolTipAid("smooth_sand_stone_slab_energy", SANDSTONE);
    public static final SlabBlock RED_SMOOTH_SAND_STONE_SLAB_ENERGY = noToolTipAid("red_smooth_sand_stone_slab_energy", RED_SANDSTONE);
    ...
    public static final SlabBlock GRAY_SMOOTH_SAND_STONE_SLAB_ENERGY = noToolTipAid("gray_smooth_sand_stone_slab_energy", GRAY_SAND_STONE);
