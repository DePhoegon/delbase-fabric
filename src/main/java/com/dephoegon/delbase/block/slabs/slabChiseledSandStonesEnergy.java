...
public class slabChiseledSandStonesEnergy extends baseModBlocks {
    ...
    public static final SlabBlock GRAY_CHISELED_SAND_STONE_SLAB_ENERGY = noToolTipAid("gray_chiseled_sand_stone_slab_energy", GREEN_SAND_STONE);
    ...
    private static SlabBlock chiseledSandStoneHelper(String name, Block block, String norm, String Shift, String Ctrl) { return (SlabBlock) registerBlock(name, new chiseledSandStoneSlabEnergy(FabricBlockSettings.copyOf(block).sounds(BlockSoundGroup.STONE), norm, Shift, Ctrl)); }
