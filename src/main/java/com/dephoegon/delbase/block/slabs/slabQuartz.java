...
public class slabQuartz extends baseModBlocks {
    ...
    private static SlabBlock quartzSlabRegister(String name, Block block, String norm, String Shift, String Ctrl) { return (SlabBlock) registerBlock(name, new quartzSlab(AbstractBlock.Settings.copy(block).sounds(BlockSoundGroup.STONE), norm, Shift, Ctrl)); }
