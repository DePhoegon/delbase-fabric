...
public class slabSandStonesEnergy extends baseModBlocks {
    ...
    public static final SlabBlock GRAY_SAND_STONE_SLAB_ENERGY = noToolTipAid("gray_sand_stone_slab_energy", GRAY_SAND_STONE);
    ...
    private static SlabBlock cutSandStoneHelper(String name, Block block, String norm, String Shift, String Ctrl) { return (SlabBlock) registerBlock(name, new sandStoneSlabEnergy(AbstractBlock.Settings.copy(block).sounds(BlockSoundGroup.STONE), norm, Shift, Ctrl)); }
