...
public class stairQuartz extends baseModBlocks {
    ...
    private static StairsBlock quartzStairRegister(String name, @NotNull Block block, String norm, String Shift, String Ctrl) { return (StairsBlock) registerBlock(name, new quartzStair(block.getDefaultState(), FabricBlockSettings.copyOf(block).sounds(BlockSoundGroup.STONE), norm, Shift, Ctrl)); }
