...
public class stairBlock extends StairsBlock {
    ...
    public stairBlock(BlockState baseBlockState, Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, StairsBlock StrippedStairBlock) {
        ...
        strippedState = StrippedStairBlock != null ? StrippedStairBlock.getDefaultState() : null;
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, @NotNull PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (stack.getItem() instanceof AxeItem && strippedState != null) {
            ...
            if (!world.isClient) {
                blockReplacer.StairPlacement(world, pos, state, strippedState);
