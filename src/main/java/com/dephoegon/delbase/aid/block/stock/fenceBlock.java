...
public class fenceBlock extends FenceBlock {
    ...
    public fenceBlock(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, FenceBlock StrippedFenceBlock) {
        super(settings);
        ...
        strippedState = StrippedFenceBlock != null ? StrippedFenceBlock.getDefaultState() : null;
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, @NotNull PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (stack.getItem() instanceof AxeItem && strippedState != null) {
            ...
            if (!world.isClient) {
                blockReplacer.FencePlacement(world, pos, state, strippedState);
