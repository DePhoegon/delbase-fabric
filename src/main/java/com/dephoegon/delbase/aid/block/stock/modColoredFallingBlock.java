...
public class modColoredFallingBlock extends ColoredFallingBlock {
    private final String tip0;
    private final String tip1;
    private final String tip2;
    private final BlockState strippedState;
    private final boolean fall;
    public modColoredFallingBlock(ColorCode color, Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, FallingBlock StrippedFallingBlock, boolean falls) {
    ...
    private boolean gravMatch(@NotNull Block block) { return block.getDefaultState() == SAND.getDefaultState() || block.getDefaultState() == RED_SAND.getDefaultState() || block instanceof modColoredFallingBlock; }
