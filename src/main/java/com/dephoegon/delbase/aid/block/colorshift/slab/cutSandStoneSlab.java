...
public class cutSandStoneSlab extends modSlabBlock {
    public cutSandStoneSlab(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip) {
