...
public class chiseledSandStoneSlab extends modSlabBlock {
    public chiseledSandStoneSlab(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip) {
