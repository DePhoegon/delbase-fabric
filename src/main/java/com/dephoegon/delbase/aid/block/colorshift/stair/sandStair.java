...
public class sandStair extends stairBlock {
    public sandStair(BlockState baseBlockState, Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, StairsBlock StrippedStairBlock) {
