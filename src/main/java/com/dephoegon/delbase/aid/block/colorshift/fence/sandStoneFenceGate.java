...
public class sandStoneFenceGate extends modFenceGate {
    public sandStoneFenceGate(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip) {
