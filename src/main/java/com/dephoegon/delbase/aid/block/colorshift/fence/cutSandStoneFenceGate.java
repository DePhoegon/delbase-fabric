...
public class cutSandStoneFenceGate extends modFenceGate {
    public cutSandStoneFenceGate(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip) {
