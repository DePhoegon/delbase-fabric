...
public class chiseledSandStoneFenceGate extends fenceGateBlock {
    public chiseledSandStoneFenceGate(Settings settings, @NotNull String normToolTip, String shiftToolTip, String ctrlToolTip, FenceGateBlock StrippedFenceGateBlock) {
