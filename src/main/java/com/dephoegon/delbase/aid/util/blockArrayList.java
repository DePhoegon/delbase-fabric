...
public abstract class blockArrayList {
    ...
    public static Block @NotNull [] getNonColoredLeaves() {
        return new Block[] {AZALEA_HEDGE, AZALEA_LEAF_FENCE, AZALEA_LEAF_SLAB, AZALEA_LEAF_FENCE_GATE, AZALEA_LEAF_STAIR, FLOWERING_AZALEA_HEDGE, FLOWERING_AZALEA_LEAF_FENCE, FLOWERING_AZALEA_LEAF_FENCE_GATE, FLOWERING_AZALEA_LEAF_SLAB, FLOWERING_AZALEA_LEAF_STAIR, CHERRY_HEDGE, CHERRY_LEAF_FENCE, CHERRY_LEAF_FENCE_GATE, CHERRY_LEAF_SLAB, CHERRY_LEAF_STAIR};
    }
    ...
    private static void setVanillaWoodList() {
        ...
        setWood_list.add(STRIPPED_CHERRY_WOOD.getDefaultState());
        setWood_list.add(CHERRY_WOOD.getDefaultState());
    ...
    // call methods to set private lists, called first in the register list to avoid any issue
