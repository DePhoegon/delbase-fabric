...
public class blockCutterStationRecipes implements Recipe<SimpleInventory> {
    ...
    private @NotNull ItemStack getDefault(@NotNull ItemStack input) { return input.getItem().asItem().getDefaultStack(); }
    ...
    public boolean matches(@NotNull SimpleInventory pContainer, World world) {
